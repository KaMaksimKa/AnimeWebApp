...
{
    public class SortAndNumberPageForRoute
    {
        ...
        public string GetPathFromContext(VirtualPathContext context)
        {
            var sort = context.Values["sort"]?.ToString();
            var numberPage = context.Values["numberPage"]?.ToString();
            var path = "";
